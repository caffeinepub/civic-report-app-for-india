...
import { UserCheck, Upload, User, MapPin, Phone, Mail, Loader2, AlertTriangle, CheckCircle, Shield, Eye, EyeOff } from 'lucide-react';
import { useInternetIdentity } from '../hooks/useInternetIdentity';
import { useFileUpload } from '../blob-storage/FileStorage';
import { useApplyVolunteer, useGetMyVolunteerProfile, useSaveUserProfile } from '../hooks/useQueries';
...
export function VolunteerRegistration() {
  ...
  const { mutate: applyVolunteer, isPending: isSubmittingApplication } = useApplyVolunteer();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!identity) {
      alert('Please sign in with Internet Identity to submit your volunteer application.');
      return;
    }
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Thank you for applying to become a verified volunteer. Your application with full details (photo, contact info, address) has been submitted and is now under review by our admin team.
          </p>
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <h3 className="font-semibold text-blue-900 mb-2">What happens next?</h3>
            <ul className="text-sm text-blue-800 text-left space-y-1">
              <li>• Admin team will review your complete application with all details</li>
              <li>• Your photo, contact info, and address are securely stored</li>
              <li>• You'll receive approval/rejection notification</li>
              <li>• If approved, you'll get verified volunteer status</li>
              <li>• Your profile will appear in the public volunteer directory</li>
              <li>• Your name will be auto-filled in report forms</li>
              <li>• You'll receive a volunteer badge on reports and certificates</li>
            </ul>
          </div>
  ...
  if (identity && existingVolunteerProfile) {
    ...
    return (
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          <UserCheck className={`h-16 w-16 mx-auto mb-4 ${isApproved ? 'text-green-500' : 'text-yellow-500'}`} />
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            {isApproved ? "You're Already a Verified Volunteer!" : "Application Under Review"}
          </h2>
          <p className="text-gray-600 mb-6">
            {isApproved 
          ...
          <button
            ...
            className={`px-6 py-3 rounded-lg transition-colors font-medium text-white ${
              isApproved ? 'bg-green-600 hover:bg-green-700' : 'bg-blue-600 hover:bg-blue-700'
            }`}
          >
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-md p-8">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Become a Verified Volunteer</h2>
            <p className="text-gray-600 mb-6">
              Join our verified volunteer program to gain credibility and recognition for your civic contributions. 
              You need to sign in with Internet Identity to submit your application with full details.
            </p>
            
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
              <h3 className="font-semibold text-green-900 mb-2">Volunteer Benefits</h3>
              <ul className="text-sm text-green-800 text-left space-y-1">
                <li>• Verified volunteer badge on all your reports and certificates</li>
                ...
                <li>• Public directory listing with your contact information</li>
                <li>• Enhanced credibility for your civic engagement</li>
                <li>• Secure storage of your profile photo and contact details</li>
              </ul>
            </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Fill out the form below to apply for verified volunteer status. All fields are required and will be stored securely.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => {
                setApplication(prev => ({ ...prev, address: e.target.value }));
            ...
            {photoPreview ? (
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-600 mb-2">Photo selected successfully</p>
                  <button
                    type="button"
                    onClick={() => {
              ...
              <div className="flex-1">
                    ...
                    <div className="ml-4 flex flex-col items-center space-y-2">
                      <Switch
                        ...
                        onCheckedChange={(checked) => 
                          setApplication(prev => ({ ...prev, showFullMobile: checked }))
                        }
                        disabled={isSubmittingApplication || isUploading}
                ...
                <div className="mt-3 p-3 bg-blue-100 rounded-lg">
                  <p className="text-xs text-blue-700 leading-relaxed">
                    <strong>Note:</strong> You can change this setting anytime after registration via your volunteer dashboard. 
                    This helps you control your privacy while still being accessible to citizens who need volunteer assistance.
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            {isSubmittingApplication || isUploading ? (
              <>
                <Loader2 className="h-5 w-5 animate-spin inline mr-2" />
                {isUploading ? 'Uploading Photo...' : 'Submitting Application...'}
              </>
            ) : (
            ...
            <div className="flex items-start space-x-2">
              ...
              <div className="text-sm text-yellow-800">
                ...
                <ul className="space-y-1">
                  ...
                  <li>• Your photo, contact info, and address will be securely stored</li>
                  <li>• Your application will be reviewed by our admin team</li>
                  <li>• Approval is not guaranteed and is at admin discretion</li>
                  <li>• Verified volunteers must maintain high standards of conduct</li>
                  <li>• Your contact information may be displayed in the public directory based on your privacy settings</li>
                  <li>• All data is stored on the secure Internet Computer blockchain</li>
                </ul>
              </div>
            </div>
          </div>
