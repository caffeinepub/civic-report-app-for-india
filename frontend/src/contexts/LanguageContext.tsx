...
const translations: Record<string, Record<string, string>> = {
  'en': {
    ...
    'form.issueType.description': 'Select the category that best describes the issue',
    ...
    'form.additionalInfo.description': 'Optional details about you and the issue',
    ...
    'form.location.description': 'Your location and local leaders information for the certificate',
    'form.location.current': 'Current Location',
    'form.location.refresh': 'Refresh',
    'form.location.loading': 'Getting your location...',
    'form.location.error': 'Location access denied. Please enable location services to submit reports.',
    ...
    'form.mlaMp.description': 'Include your local MLA or MP\'s information to be displayed on the certificate',
    'form.mlaMp.name.label': 'MLA/MP Name',
    'form.mlaMp.name.placeholder': 'Enter MLA or MP name',
    'form.mlaMp.photo.label': 'MLA/MP Photo',
    'form.mlaMp.note': 'Both name and photo are required to display MLA/MP information on the certificate.',
    'form.customIssue.label': 'Please specify the issue type *',
    'form.customIssue.placeholder': 'Enter the specific civic issue you\'re reporting',
    'form.submit': 'Submit Report',
    'form.submitting': 'Submitting Report...',
    'form.disclaimer.title': 'IMPORTANT DISCLAIMER:',
    'form.disclaimer.text': 'This is NOT an official government document. This is a citizen-generated report for civic awareness purposes only. The use of leader photos does not imply official endorsement or government affiliation. No official action is guaranteed from this report.',
    ...
    'success.description': 'Your civic report has been saved. You can now generate and download your certificate.',
    ...
    'certificate.statement': 'This certificate acknowledges your contribution to civic improvement.',
    'certificate.initiative': 'Digital Civic Initiative',
    'certificate.disclaimer.title': 'IMPORTANT DISCLAIMER',
    'certificate.disclaimer.text1': 'This is NOT an official government document. This is a citizen-generated report for civic awareness purposes only.',
    'certificate.disclaimer.text2': 'The use of leader photos does not imply official endorsement or government affiliation.',
    'certificate.disclaimer.text3': 'No official action is guaranteed from this report.',
    ...
    'reports.resolutionNotesPlaceholder': 'Add any comments about how the issue was resolved...',
    ...
    'roadmap.implemented.subtitle': 'Features that have been completed and are live',
    'roadmap.underConsideration.title': 'Under Consideration',
    'roadmap.underConsideration.subtitle': 'Features being evaluated or in planning phase',
    ...
    'roadmap.noFeaturesDescription': 'The development roadmap will appear here once features are added.',
    'roadmap.addFirstFeature': 'Add First Feature',
    'roadmap.noMatchingFeatures': 'No features match your filters',
    'roadmap.adjustFilters': 'Try adjusting your search terms or filters to see more results.',
    'roadmap.dragInstructions': 'Drag feature cards between sections to update their status. Changes are saved automatically when you drop a card in a new section.',
    'roadmap.adminMode': 'Admin Mode Active',
    'roadmap.adminModeDescription': 'You can add, edit, delete, and drag features between sections. Changes are saved automatically.',
    ...
    'verify.description': 'This is an authentic civics issue report submitted through our platform',
    ...
    'verify.confirmed.description': 'This report has been verified as authentic and was submitted through the official Civics Issue Report App for India. The report details, timestamp, and location data have been cryptographically secured and cannot be tampered with.',
    'verify.notFound.title': 'Report Not Found',
    'verify.notFound.description': 'The report you\'re looking for doesn\'t exist or may have been removed.',
  ...
  'hi': {
    ...
    'form.subtitle': 'नागरिक समस्याओं की रिपोर्ट करके अपने समुदाय को बेहतर बनाने में मदद करें',
    ...
    'form.location.description': 'प्रमाणपत्र के लिए आपका स्थान और स्थानीय नेताओं की जानकारी',
    'form.location.current': 'वर्तमान स्थान',
    'form.location.refresh': 'रीफ्रेश',
    'form.location.loading': 'आपका स्थान प्राप्त कर रहे हैं...',
    'form.location.error': 'स्थान पहुंच से इनकार कर दिया गया। रिपोर्ट जमा करने के लिए स्थान सेवाएं सक्षम करें।',
    ...
    'form.mlaMp.description': 'प्रमाणपत्र पर प्रदर्शित होने के लिए अपने स्थानीय विधायक या सांसद की जानकारी शामिल करें',
    ...
    'form.mlaMp.note': 'प्रमाणपत्र पर विधायक/सांसद जानकारी प्रदर्शित करने के लिए नाम और फोटो दोनों आवश्यक हैं।',
    'form.customIssue.label': 'कृपया समस्या का प्रकार निर्दिष्ट करें *',
    'form.customIssue.placeholder': 'आप जिस विशिष्ट नागरिक समस्या की रिपोर्ट कर रहे हैं उसे दर्ज करें',
    'form.submit': 'रिपोर्ट जमा करें',
    'form.submitting': 'रिपोर्ट जमा कर रहे हैं...',
    'form.disclaimer.title': 'महत्वपूर्ण अस्वीकरण:',
    'form.disclaimer.text': 'यह एक आधिकारिक सरकारी दस्तावेज नहीं है। यह केवल नागरिक जागरूकता उद्देश्यों के लिए नागरिक-जनित रिपोर्ट है। नेता फोटो का उपयोग आधिकारिक समर्थन या सरकारी संबद्धता का संकेत नहीं देता। इस रिपोर्ट से किसी आधिकारिक कार्रवाई की गारंटी नहीं है।',
    ...
    'success.description': 'आपकी नागरिक रिपोर्ट सहेजी गई है। अब आप अपना प्रमाणपत्र बना और डाउनलोड कर सकते हैं।',
    ...
    'certificate.statement': 'यह प्रमाणपत्र नागरिक सुधार में आपके योगदान को स्वीकार करता है।',
    'certificate.initiative': 'डिजिटल नागरिक पहल',
    'certificate.disclaimer.title': 'महत्वपूर्ण अस्वीकरण',
    'certificate.disclaimer.text1': 'यह एक आधिकारिक सरकारी दस्तावेज नहीं है। यह केवल नागरिक जागरूकता उद्देश्यों के लिए नागरिक-जनित रिपोर्ट है।',
    'certificate.disclaimer.text2': 'नेता फोटो का उपयोग आधिकारिक समर्थन या सरकारी संबद्धता का संकेत नहीं देता।',
    'certificate.disclaimer.text3': 'इस रिपोर्ट से किसी आधिकारिक कार्रवाई की गारंटी नहीं है।',
    ...
    'reports.resolutionNotesPlaceholder': 'समस्या कैसे हल की गई इसके बारे में कोई टिप्पणी जोड़ें...',
    ...
    'roadmap.underConsideration.subtitle': 'सुविधाएं जिनका मूल्यांकन या योजना चरण में है',
    ...
    'roadmap.noFeaturesDescription': 'सुविधाएं जोड़े जाने पर विकास रोडमैप यहां दिखाई देगा।',
    'roadmap.addFirstFeature': 'पहली सुविधा जोड़ें',
    'roadmap.noMatchingFeatures': 'कोई सुविधा आपके फिल्टर से मेल नहीं खाती',
    'roadmap.adjustFilters': 'अधिक परिणाम देखने के लिए अपने खोज शब्दों या फिल्टर को समायोजित करने का प्रयास करें।',
    'roadmap.dragInstructions': 'उनकी स्थिति अपडेट करने के लिए सुविधा कार्ड को अनुभागों के बीच खींचें। जब आप किसी नए अनुभाग में कार्ड छोड़ते हैं तो परिवर्तन स्वचालित रूप से सहेजे जाते हैं।',
    'roadmap.adminMode': 'एडमिन मोड सक्रिय',
    'roadmap.adminModeDescription': 'आप अनुभागों के बीच सुविधाएं जोड़, संपादित, हटा और खींच सकते हैं। परिवर्तन स्वचालित रूप से सहेजे जाते हैं।',
    ...
    'verify.description': 'यह हमारे प्लेटफॉर्म के माध्यम से जमा की गई एक प्रामाणिक नागरिक समस्या रिपोर्ट है',
    ...
    'verify.confirmed.description': 'यह रिपोर्ट प्रामाणिक के रूप में सत्यापित की गई है और भारत के लिए आधिकारिक नागरिक मुद्दा रिपोर्ट ऐप के माध्यम से जमा की गई है। रिपोर्ट विवरण, टाइमस्टैम्प और स्थान डेटा को क्रिप्टोग्राफिक रूप से सुरक्षित किया गया है और इसे छेड़छाड़ नहीं किया जा सकता।',
    'verify.notFound.title': 'रिपोर्ट नहीं मिली',
    'verify.notFound.description': 'आप जिस रिपोर्ट की तलाश कर रहे हैं वह मौजूद नहीं है या हटा दी गई हो सकती है।',
  ...
  'ta': {
    ...
    'form.subtitle': 'குடிமக்கள் பிரச்சினைகளை அறிக்கை செய்வதன் மூலம் உங்கள் சமுதாயத்தை மேம்படுத்த உதவுங்கள்',
    'form.issueType.title': 'நீங்கள் எந்த வகையான குடிமக்கள் பிரச்சினையை அறிக்கை செய்கிறீர்கள்?',
    'form.issueType.description': 'பிரச்சினையை சிறப்பாக விவரிக்கும் வகையை தேர்ந்தெடுக்கவும்',
    'form.photo.title': 'பிரச்சினையின் புகைப்படத்தை பதிவேற்றவும் *',
    'form.photo.description': 'குடிமக்கள் பிரச்சினையை காட்டும் தெளிவான புகைப்படம் எடுக்கவும்',
    'form.additionalInfo.title': 'கூடுதல் தகவல்',
    'form.additionalInfo.description': 'உங்களைப் பற்றியும் பிரச்சினையைப் பற்றியும் விருப்பமான விவரங்கள்',
    ...
    'form.location.description': 'சான்றிதழுக்கான உங்கள் இடம் மற்றும் உள்ளூர் தலைவர்களின் தகவல்',
    'form.location.current': 'தற்போதைய இடம்',
    'form.location.refresh': 'புதுப்பிக்கவும்',
    'form.location.loading': 'உங்கள் இடத்தைப் பெறுகிறது...',
    'form.location.error': 'இட அணுகல் மறுக்கப்பட்டது. அறிக்கைகளை சமர்ப்பிக்க இட சேவைகளை இயக்கவும்.',
    ...
    'form.mlaMp.description': 'சான்றிதழில் காட்டப்படுவதற்கு உங்கள் உள்ளூர் MLA அல்லது MP இன் தகவலைச் சேர்க்கவும்',
    ...
    'form.mlaMp.note': 'சான்றிதழில் MLA/MP தகவலைக் காட்ட பெயர் மற்றும் புகைப்படம் இரண்டும் தேவை.',
    'form.customIssue.label': 'தயவுசெய்து பிரச்சினை வகையை குறிப்பிடவும் *',
    'form.customIssue.placeholder': 'நீங்கள் அறிக்கை செய்யும் குறிப்பிட்ட குடிமக்கள் பிரச்சினையை உள்ளிடவும்',
    'form.submit': 'அறிக்கையை சமர்ப்பிக்கவும்',
    'form.submitting': 'அறிக்கையை சமர்ப்பிக்கிறது...',
    'form.disclaimer.title': 'முக்கியமான மறுப்பு:',
    'form.disclaimer.text': 'இது அதிகாரப்பூர்வ அரசாங்க ஆவணம் அல்ல। இது குடிமக்கள் விழிப்புணர்வு நோக்கங்களுக்காக மட்டுமே குடிமக்களால் உருவாக்கப்பட்ட அறிக்கை. தலைவர் புகைப்படங்களின் பயன்பாடு அதிகாரப்பூர்வ ஒப்புதல் அல்லது அரசாங்க இணைப்பைக் குறிக்காது. இந்த அறிக்கையிலிருந்து எந்த அதிகாரப்பூர்வ நடவடிக்கைக்கும் உத்தரவாதம் இல்லை.',
    ...
    'success.description': 'உங்கள் குடிமக்கள் அறிக்கை சேமிக்கப்பட்டுள்ளது. இப்போது நீங்கள் உங்கள் சான்றிதழை உருவாக்கி பதிவிறக்கலாம்.',
    ...
    'certificate.statement': 'இந்த சான்றிதழ் குடிமக்கள் மேம்பாட்டில் உங்கள் பங்களிப்பை ஒப்புக்கொள்கிறது.',
    'certificate.initiative': 'டிஜிட்டல் குடிமக்கள் முன்முயற்சி',
    'certificate.disclaimer.title': 'முக்கியமான மறுப்பு',
    'certificate.disclaimer.text1': 'இது அதிகாரப்பூர்வ அரசாங்க ஆவணம் அல்ல. இது குடிமக்கள் விழிப்புணர்வு நோக்கங்களுக்காக மட்டுமே குடிமக்களால் உருவாக்கப்பட்ட அறிக்கை.',
    'certificate.disclaimer.text2': 'தலைவர் புகைப்படங்களின் பயன்பாடு அதிகாரப்பூர்வ ஒப்புதல் அல்லது அரசாங்க இணைப்பைக் குறிக்காது.',
    'certificate.disclaimer.text3': 'இந்த அறிக்கையிலிருந்து எந்த அதிகாரப்பூர்வ நடவடிக்கைக்கும் உத்தரவாதம் இல்லை.',
    ...
    'reports.empty.description': 'குடிமக்கள் அறிக்கையை சமர்ப்பிக்கும் முதல் நபராக இருங்கள்!',
    ...
    'reports.resolutionNotesPlaceholder': 'பிரச்சினை எவ்வாறு தீர்க்கப்பட்டது என்பது பற்றி ஏதேனும் கருத்துகளைச் சேர்க்கவும்...',
    ...
    'roadmap.underConsideration.subtitle': 'மதிப்பீடு அல்லது திட்டமிடல் கட்டத்தில் உள்ள அம்சங்கள்',
    ...
    'roadmap.searchPlaceholder': 'தலைப்பு அல்லது விளக்கத்தின் மூலம் அம்சங்களைத் தேடவும்...',
    ...
    'roadmap.noFeaturesDescription': 'அம்சங்கள் சேர்க்கப்பட்டவுடன் வளர்ச்சி வரைபடம் இங்கே தோன்றும்.',
    ...
    'roadmap.adjustFilters': 'அதிக முடிவுகளைக் காண உங்கள் தேடல் சொற்கள் அல்லது வடிப்பான்களை சரிசெய்ய முயற்சிக்கவும்.',
    'roadmap.dragInstructions': 'அவற்றின் நிலையைப் புதுப்பிக்க பிரிவுகளுக்கு இடையே அம்ச அட்டைகளை இழுக்கவும். நீங்கள் ஒரு புதிய பிரிவில் அட்டையை விடும்போது மாற்றங்கள் தானாகவே சேமிக்கப்படும்.',
    'roadmap.adminMode': 'நிர்வாக பயன்முறை செயலில்',
    'roadmap.adminModeDescription': 'நீங்கள் பிரிவுகளுக்கு இடையே அம்சங்களைச் சேர்க்கலாம், திருத்தலாம், நீக்கலாம் மற்றும் இழுக்கலாம். மாற்றங்கள் தானாகவே சேமிக்கப்படும்.',
    ...
    'verify.description': 'இது எங்கள் தளத்தின் மூலம் சமர்ப்பிக்கப்பட்ட ஒரு உண்மையான குடிமக்கள் பிரச்சினை அறிக்கை',
    ...
    'verify.confirmed.description': 'இந்த அறிக்கை உண்மையானது என சரிபார்க்கப்பட்டு, இந்தியாவுக்கான அதிகாரப்பூர்வ குடிமக்கள் பிரச்சினை அறிக்கை ஆப்பின் மூலம் சமர்ப்பிக்கப்பட்டுள்ளது. அறிக்கை விவரங்கள், நேர முத்திரை மற்றும் இட தரவு கிரிப்டோகிராஃபிக் முறையில் பாதுகாக்கப்பட்டுள்ளன மற்றும் அவற்றை மாற்ற முடியாது.',
    'verify.notFound.title': 'அறிக்கை கிடைக்கவில்லை',
    'verify.notFound.description': 'நீங்கள் தேடும் அறிக்கை இல்லை அல்லது அகற்றப்பட்டிருக்கலாம்.',
  ...
  'te': {
    ...
    'success.description': 'మీ పౌర రిపోర్ట్ సేవ్ చేయబడింది. ఇప్పుడు మీరు మీ సర్టిఫికేట్‌ను రూపొందించి డౌన్‌లోడ్ చేయవచ్చు.',
  ...
  'bn': {
    ...
    'form.issueType.description': 'সমস্যাটি সবচেয়ে ভালোভাবে বর্ণনা করে এমন বিভাগ নির্বাচন করুন',
    ...
    'success.description': 'আপনার নাগরিক রিপোর্ট সংরক্ষিত হয়েছে। এখন আপনি আপনার সার্টিফিকেট তৈরি এবং ডাউনলোড করতে পারেন।',
  ...
  'mr': {
    ...
    'success.description': 'तुमचा नागरी अहवाल जतन केला गेला आहे. आता तुम्ही तुमचे प्रमाणपत्र तयार करू आणि डाउनलोड करू शकता.',
  ...
  'kn': {
    ...
    'form.subtitle': 'ನಾಗರಿಕ ಸಮಸ್ಯೆಗಳನ್ನು ವರದಿ ಮಾಡುವ ಮೂಲಕ ನಿಮ್ಮ ಸಮುದಾಯವನ್ನು ಸುಧಾರಿಸಲು ಸಹಾಯ ಮಾಡಿ',
    ...
    'success.description': 'ನಿಮ್ಮ ನಾಗರಿಕ ವರದಿಯನ್ನು ಉಳಿಸಲಾಗಿದೆ. ಈಗ ನೀವು ನಿಮ್ಮ ಪ್ರಮಾಣಪತ್ರವನ್ನು ರಚಿಸಬಹುದು ಮತ್ತು ಡೌನ್‌ಲೋಡ್ ಮಾಡಬಹುದು.',
  ...
  'bho': {
    ...
    'form.subtitle': 'नागरिक समस्या के रिपोर्ट करके अपना समुदाय के बेहतर बनावे में मदद करीं',
    ...
    'success.description': 'रउआ के नागरिक रिपोर्ट सेव हो गइल बा। अब रउआ अपना सर्टिफिकेट बना के डाउनलोड कर सकत बानी।',
    'common.primeMinister': 'प्रधान मंत्री',
    'common.chiefMinister': 'मुख्यमंत्री',
  }
};
