...
import { Check, Copy, Settings, Shield, UserPlus, Users } from "lucide-react";
...
export function UserManagement() {
  ...
  const [activeTab, setActiveTab] = useState<"profile" | "admin-management">(
    "admin-management",
  );
      ...
      assignRole(
        ...
        },
        {
          ...
          onError: (error) => {
            ...
            alert(
              "Failed to assign admin role. Please check the principal ID and try again.",
            );
          },
        },
      );
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <p className="text-gray-600">
          Manage user profiles and admin access for the civic reporting
          platform.
        </p>
      </div>
        ...
        <div className="space-y-6">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
              <div className="flex items-start space-x-2">
                ...
                <div className="text-sm text-yellow-800">
                  ...
                  <p>
                    This is the legacy admin assignment method. For better admin
                    management, please use the "Admin Management" tab above.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
            ...
            <div className="space-y-3 text-sm text-blue-800">
              <p>
                ...
                Computer dApp while logged in with Internet Identity, then check
                the browser's developer console for their principal ID.
              </p>
              <p>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
            ...
            <div className="space-y-2 text-sm text-yellow-800">
              ...
              <p>
                • There is no automatic admin assignment - all admin rights must
                be explicitly granted
              </p>
              <p>
                • Use the Admin Management tab for better control over admin
                access
              </p>
              <p>
                • All admin management operations are now secured with dedicated
                backend methods
              </p>
            </div>
          </div>
