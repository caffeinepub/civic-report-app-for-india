...
import {
  useGetMyPendingProfileEdit,
  useGetMyProfileEditHistory,
  useGetMyVolunteerProfile,
  useGetVolunteerStats,
  useSubmitVolunteerProfileEdit,
  useUpdateVolunteerPrivacy,
...
export function VolunteerDashboard() {
  ...
  const { data: volunteerProfile, isLoading: isLoadingProfile } =
    useGetMyVolunteerProfile();
  ...
  const { mutate: updatePrivacy, isPending: isUpdatingPrivacy } =
    useUpdateVolunteerPrivacy();
  const { mutate: submitProfileEdit, isPending: isSubmittingEdit } =
    useSubmitVolunteerProfileEdit();
      ...
      <div className="max-w-md mx-auto px-4">
        <Card className="text-center">
          <CardContent className="pt-8 pb-6">
            ...
            <p className="text-gray-600 text-sm mb-6">
              You haven't submitted a volunteer application yet. Apply now to
  ...
  const daysSinceApplication = getDaysSinceApplication(
    volunteerProfile.applicationDate,
  );
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <div className="flex items-center justify-center sm:justify-start space-x-2 mb-3">
                ...
                <Badge
                  variant={getStatusVariant(volunteerProfile)}
                  className="text-xs"
                >
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-blue-700 text-xs mt-1">
                  Your profile update request is being reviewed by admins.
          ...
          <Card className="text-center">
            <CardContent className="pt-4 pb-3">
              ...
              <div className="text-lg font-bold text-gray-900">
                {volunteerStats.reportsSubmitted}
              </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Your verified volunteer details
              </p>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-blue-700 leading-relaxed">
                  All your personal information is securely stored on the
                  Internet Computer blockchain and is only accessible to
                  verified admins for approval purposes.
                </p>
              </div>
            </div>
          </div>
          ...
          {timelineEntries.map((entry, index) => {
            ...
            return (
              <div key={`edit-${index}`} className="flex items-start space-x-3">
                <div
                  className={`w-6 h-6 ${getEditStatusColor(entry.status)} rounded-full flex items-center justify-center flex-shrink-0`}
                >
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-green-700 text-xs mt-1 mb-3">
                  Your profile is live in the public volunteer directory!
                  Citizens can find your contact information.
                </p>
                <Button
        ...
        <DialogContent className="sm:max-w-[600px] bg-white bg-opacity-95 backdrop-blur-md border border-gray-200 shadow-2xl">
          <DialogHeader>
            ...
            <DialogDescription className="text-sm text-gray-600">
              Submit changes for admin approval. Your current profile will
              remain active until changes are approved.
            </DialogDescription>
          </DialogHeader>
