...
import { Building2, Mail, Phone, MapPin, Globe, FileText, Clock, CheckCircle, XCircle, Shield, TrendingUp, Star } from 'lucide-react';
import { useInternetIdentity } from '../hooks/useInternetIdentity';
import { useGetMyNgoNpoProfile, useUpdateNgoNpoPrivacy } from '../hooks/useQueries';
...
export function NgoNpoDashboard() {
  ...
  const { data: ngoNpoProfile, isLoading: isLoadingProfile } = useGetMyNgoNpoProfile();
  const { data: logoUrl } = useFileUrl(ngoNpoProfile?.logoPath || '');
  const { mutate: updatePrivacy, isPending: isUpdatingPrivacy } = useUpdateNgoNpoPrivacy();
        ...
        <Card className="text-center">
          <CardContent className="pt-8 pb-6">
            ...
            <p className="text-gray-600 text-sm mb-6">
              Sign in with Internet Identity to access your organization dashboard.
            </p>
      ...
      <div className="max-w-md mx-auto px-4">
        <Card className="text-center">
          <CardContent className="pt-8 pb-6">
            ...
            <p className="text-gray-600 text-sm">Checking your organization status...</p>
          </CardContent>
        </Card>
      </div>
    );
    ...
    return (
      <div className="max-w-md mx-auto px-4">
        <Card className="text-center">
          <CardContent className="pt-8 pb-6">
            <Building2 className="h-12 w-12 text-blue-500 mx-auto mb-4" />
            <CardTitle className="text-xl mb-3">No Registration Found</CardTitle>
            <p className="text-gray-600 text-sm mb-6">
              You haven't registered your NGO/NPO yet. Register now to join our platform.
            </p>
  ...
  const daysSinceRegistration = getDaysSinceRegistration(ngoNpoProfile.registrationDate);
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                ...
                <div className="bg-white border border-red-200 rounded p-2">
                  <p className="text-red-800 text-xs font-medium">{ngoNpoProfile.rejectionNote}</p>
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
          ...
          <Card className="text-center">
            <CardContent className="pt-4 pb-3">
              ...
              <div className="text-lg font-bold text-gray-900">{daysSinceRegistration}</div>
        ...
        <CardContent className="p-6">
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg px-4 py-3">
                  <p className="text-gray-900 font-medium break-all">{ngoNpoProfile.email}</p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg px-4 py-3">
                  <p className="text-gray-900 font-medium">{ngoNpoProfile.phone}</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg px-4 py-3">
                <p className="text-gray-900 font-medium leading-relaxed">{ngoNpoProfile.address}</p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg px-4 py-3">
                <p className="text-gray-900 leading-relaxed">{ngoNpoProfile.description}</p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg px-4 py-3">
                <p className="text-gray-900 leading-relaxed">{ngoNpoProfile.missionStatement}</p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg px-4 py-3">
                <p className="text-gray-900 font-medium">{ngoNpoProfile.contactPerson}</p>
              </div>
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <p className="font-medium text-gray-900 text-sm">Registration Submitted</p>
              <p className="text-xs text-gray-600">
                {new Date(Number(ngoNpoProfile.registrationDate) / 1000000).toLocaleDateString('en-IN', {
                  year: 'numeric',
                  month: 'short',
                  day: 'numeric'
                })}
          ...
          {ngoNpoProfile.approved && (
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                <p className="font-medium text-gray-900 text-sm">Application Approved</p>
                <p className="text-xs text-gray-600">Listed in public directory</p>
              </div>
            </div>
          )}
        </CardContent>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-green-700 text-xs mt-1 mb-3">
                  Your organization is live in the public directory! Citizens can find your information.
                </p>
                <Button
