...
import { Building2, Upload, User, MapPin, Phone, Mail, Loader2, AlertTriangle, CheckCircle, Shield, Globe, FileText } from 'lucide-react';
import { useInternetIdentity } from '../hooks/useInternetIdentity';
import { useFileUpload } from '../blob-storage/FileStorage';
import { useRegisterNgoNpo, useGetMyNgoNpoProfile, useSaveUserProfile } from '../hooks/useQueries';
...
export function NgoNpoRegistration() {
  ...
  const { mutate: registerNgoNpo, isPending: isSubmittingApplication } = useRegisterNgoNpo();
  ...
  const validateForm = (): boolean => {
    ...
    if (!application.missionStatement.trim()) {
      ...
      newErrors.missionStatement = 'Mission statement must be at least 20 characters long';
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!identity) {
      alert('Please sign in with Internet Identity to submit your NGO/NPO application.');
      return;
    }
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Thank you for registering your NGO/NPO. Your application has been submitted and is now under review by our admin team.
          </p>
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            ...
            <ul className="text-sm text-blue-800 text-left space-y-1">
              ...
              <li>• If approved, your organization will appear in the public directory</li>
  ...
  if (identity && existingNgoNpoProfile) {
    ...
    return (
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          <Building2 className={`h-16 w-16 mx-auto mb-4 ${isApproved ? 'text-green-500' : 'text-yellow-500'}`} />
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            {isApproved ? "Your Organization is Already Registered!" : "Application Under Review"}
          </h2>
          <p className="text-gray-600 mb-6">
            {isApproved 
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-md p-8">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Register Your NGO/NPO</h2>
            <p className="text-gray-600 mb-6">
              Join our platform to connect with citizens and track your organization's impact on civic issues. 
              You need to sign in with Internet Identity to submit your application.
            </p>
            
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
              <h3 className="font-semibold text-green-900 mb-2">Platform Benefits</h3>
              <ul className="text-sm text-green-800 text-left space-y-1">
                <li>• Public directory listing for visibility</li>
                <li>• Track reports submitted or supported by your organization</li>
    ...
    <div className="max-w-2xl mx-auto">
      <div className="bg-white rounded-lg shadow-md p-8">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">NGO/NPO Registration</h2>
          <p className="text-gray-600">
            Fill out the form below to register your organization. All fields are required unless marked optional.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                setApplication(prev => ({ ...prev, organizationName: e.target.value }));
            ...
            {logoPreview ? (
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-600 mb-2">Logo selected successfully</p>
                  <button
                    type="button"
                    onClick={() => {
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                setApplication(prev => ({ ...prev, contactPerson: e.target.value }));
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => {
                setApplication(prev => ({ ...prev, missionStatement: e.target.value }));
                    ...
                    <div className="ml-4 flex flex-col items-center space-y-2">
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                          ...
                          onChange={(e) => setApplication(prev => ({ ...prev, showContactInfo: e.target.checked }))}
          ...
          >
            {isSubmittingApplication || isUploading ? (
              <>
                <Loader2 className="h-5 w-5 animate-spin inline mr-2" />
                {isUploading ? 'Uploading Logo...' : 'Submitting Application...'}
              </>
            ) : (
            ...
            <div className="flex items-start space-x-2">
              ...
              <div className="text-sm text-yellow-800">
                ...
                <ul className="space-y-1">
                  ...
                  <li>• Registered organizations must maintain high standards</li>
